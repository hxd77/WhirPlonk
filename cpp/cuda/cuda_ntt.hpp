...
void launch_ntt_radix2(uint64_t* data, const uint64_t* roots, uint32_t n, uint32_t stride, uint32_t batches, cudaStream_t stream = nullptr);
void launch_ntt_radix4(uint64_t* data, const uint64_t* roots, uint32_t n, uint32_t stride, uint32_t batches, cudaStream_t stream = nullptr);
void launch_apply_twiddles(uint64_t* data, const uint64_t* roots, uint32_t rows, uint32_t cols, uint32_t step, uint32_t batches, cudaStream_t stream = nullptr);
void launch_transpose(const uint64_t* src, uint64_t* dst, uint32_t rows, uint32_t cols, uint32_t batches, cudaStream_t stream = nullptr);
void launch_pack_rs_coeffs(const uint64_t* coeffs, uint64_t* out,
                           uint32_t poly_size, uint32_t codeword_length,
                           uint32_t interleaving_depth, uint32_t num_polys, cudaStream_t stream = nullptr);
