---
name: "source-command-unit-test-expand"
description: "Increase test coverage by targeting untested branches and edge cases"
---

# source-command-unit-test-expand

Use this skill when the user asks to run the migrated source command `unit-test-expand`.
